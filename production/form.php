          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Ürün Ekle <small>Ürün Özelliklerini Girin</small></h2>
...
<div class="form-group">
  ...
  <div class="col-md-6 col-sm-6 col-xs-12">
    <input type="text" id="first-name" required="required" name="cataname" value="<?php echo $ayarcek['cataname'] ?>" class="form-control col-md-7 col-xs-12">
  </div>
</div>
...
<div class="form-group">
  <div align="right" class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
    <button name="iletisimayarkaydet" type="submit" class="btn btn-success">Kaydet</button>
  </div>
</div>
